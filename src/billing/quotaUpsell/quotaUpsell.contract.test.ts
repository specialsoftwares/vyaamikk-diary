...
assert.match(host, /QuotaUpsellHostView/);
assert.match(host, /UpgradeSheet/);
assert.match(host, /BenefitEducationScreen/);
...
const view = stripComments(read("src/billing/quotaUpsell/QuotaUpsellHostView.tsx"));
assert.match(view, /createQuotaUpsellHostRuntime/);
assert.match(view, /runtime\.reconcile/);
assert.match(view, /trialActionAvailable: model.trialActionAvailable/);
assert.match(view, /errorRetryEnabled: model.errorRetryEnabled/);
assert.match(view, /\.catch\(/);
assert.doesNotMatch(view, /from ["']@\/components\/billing\/UpgradeSheet["']/);
assert.doesNotMatch(view, /BenefitEducationScreen/);
assert.doesNotMatch(view, /grantProfessionalTrial/);
assert.doesNotMatch(view, /\bsetDoc\b/);
assert.doesNotMatch(view, /from ["']expo-iap["']/);
