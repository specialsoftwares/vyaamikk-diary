...
assert.throws(() => assertBillingLogContext({ signedTransactionInfo: "jws" }), BillingLogPrivacyError);
assert.throws(() => assertBillingLogContext({ signedRenewalInfo: "jws" }), BillingLogPrivacyError);
